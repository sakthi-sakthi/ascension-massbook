...
export default function CalenderHeader() {
    ...
    return (
     ...
     <div >
            <center><header>
                <a href="https://ascensionchurchbangalore.org/" target="_blank"><img src={download} /></a>
            ...
            <div className="same-line">
                <div className="on-the-left">
                    <a className="nav-link" href="https://ascensionchurchbangalore.org/"
                        style={{ textdecoration: 'inherit', fontSize: '92%' }}>
                        <button className="border rounded py-2 px-4 mr-1 text-white" style={{ backgroundColor: "rgb(128,0,0)", bordercolor: "blue" }}>
                            <span>Back</span>
                        </button>
                    </a>
                </div>
